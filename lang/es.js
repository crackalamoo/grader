langData["es"] = {
  ...
  "catList": "<strong>Haz clic en una categoría</strong> para añadir o quitar asignaciones y para ver la nota de esa categoría.<br><br>Categorías:<br>",
  "catAvg": "Promedio en $CATEGORY: $NUMBER%",
  "avg": "Nota hasta ahora en esta clase: $SCORE% (Nota de letra: $LETTER)<br>" +
    "Unweighted GPA: $GPA<br>Suma de todas las categorías: $SUM% (Debe ser 100%)<br>",
  ...
  "deleteAssignment": "Borrar asignación",
  "editInstruct": "Introduce nota/posible. Ejemplos: 5/6.0, 8.5/9, 3/3.<br>" +
    "Para borrar a una asignación, introduce su nota <strong>de la misma manera</strong> y haz clic en \"Borrar asignación\".<br>" +
