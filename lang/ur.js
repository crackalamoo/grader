langData["ur"] = {
  ...
  "catList": "<strong>کسی کیٹیگری کو کلک کرو</strong> اُس کیٹیگری کا سکور دیکھنے کے لئے، کاموں کو ڈالنے یا نکالنے کے لئے، ئا اور بھی کرنے کے لئے۔<br><br>کیٹیگریز:<br>",
  ...
  "5scale": "5.0 سکیل",
  "4scale": "4.0 سکیل",
  "footer": "حارث دلوی<br>اکتوبر ۲۰۱۹ء&ndash;اگست ۲۰۲۱ء<br>اسوج سموت ۱۹۴۱&ndash;ساون سموت ۱۹۴۳",
  "languages": ["انگریزی",
    "سپینش",
    "پرتگالی",
    "فرینچ",
  ...
  "setPercent": "گریڈنگ پرسنٹ سسٹم بن گئی",
  "search": "تلاش کرو",
